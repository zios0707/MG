...
export const ticksPerMeasure = derived([beatsPerMeasure, ticksPerBeat], ([$beatsPerMeasure, $ticksPerBeat]) => $beatsPerMeasure * $ticksPerBeat);
// 박자표 표시를 위한 파생 저장소
export const timeSignature = derived([tick, ticksPerMeasure, ticksPerBeat], ([$tick, $ticksPerMeasure, $ticksPerBeat]) => {
