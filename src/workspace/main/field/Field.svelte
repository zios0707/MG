...
<!--            >-->
<!--                &lt;!&ndash; 크기 조절 반응을 위해 하위 요소 존재 &ndash;&gt;-->
<!--                &lt;!&ndash; ondragstart={dragStart} 기본 위치 세팅 &ndash;&gt;-->
<!--                &lt;!&ndash; ondrag={dragTrackingX} 계속 트래킹 &ndash;&gt;-->
<!--                &lt;!&ndash; line 에 ondragenter 를 넣어서 top 자동 조정 되도록 &ndash;&gt;-->
<!--                &lt;!&ndash; ondragend={confirmDrag} 확정 &ndash;&gt;-->
<!--                <div-->
<!--                        id="left"-->
<!--                        draggable="true"-->
<!--                >-->
